...
namespace ConsoleApp4
{
    ...
    {
        static void F(int x)    //  x=6, 5, 4, 3, 2, 1
        {
            if (x > 1)
            {
                for (int i = 0; i < x; i++)
...
//namespace ConsoleApp2_lessn_14
//{
//    internal class Program
//    {
//        static bool F(int[] a)
...
//////------------------------------------------------------
/////                      Checks whether in a sorted array
///
//using System;
//using System.Collections.Generic;
//using System.Linq;
...
//            int[] b = new int[5] { 1, 56, 78, 345, 678, };
//            Show(a);
//            bool v = IsSort(a);
//            Console.WriteLine(v);
//            Show(b);
...
//            {
//                c[i] = a[i];
//                // c[i + a.Length] = b[a.Length - 1 - i]; //option 1
//                c[c.Length - 1 - i] = b[i];               //option 2
//            }
//            Show(c);
//        }
//    }
